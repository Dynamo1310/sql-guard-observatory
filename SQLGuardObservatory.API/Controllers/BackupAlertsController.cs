...
public class BackupAlertsController : ControllerBase
{
    ...
    private BackupAlertConfigDto MapConfigToDto(BackupAlertConfig config)
    {
        return new BackupAlertConfigDto
        {
            ...
            DmzRecipients = config.DmzRecipients?.Split(',', StringSplitOptions.RemoveEmptyEntries).ToList() ?? new List<string>(),
            DmzCcRecipients = config.DmzCcRecipients?.Split(',', StringSplitOptions.RemoveEmptyEntries).ToList() ?? new List<string>(),
        ...
        try
        {
            ...
            if (config == null)
            {
                ...
                return Ok(new BackupAlertConfigDto
                {
                    ...
                    DmzRecipients = new List<string>(),
                    DmzCcRecipients = new List<string>(),
                    LastRunAt = null,
