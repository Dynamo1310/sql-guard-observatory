-- =============================================
-- Actualizar Vista: Agregar DiskDetails
-- =============================================

USE SQLNova;
GO

PRINT 'Actualizando vw_InstanceHealth_Latest para incluir DiskDetails...';
GO

-- =============================================
-- PASO 1: Recrear la vista con DiskDetails
-- =============================================
...
PRINT 'Verificando que DiskDetails esté incluido...';
SELECT TOP 5
    InstanceName,
    DiskWorstFreePct,
    DiskDetails
