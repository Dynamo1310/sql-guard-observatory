  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" onClick={() => { loadInventory(); loadConnectionStatus(); }}>
      ...
      {/* Estado actual */}
      <Card className={downInstances.length > 0 ? 'border-destructive/30 bg-destructive/5' : 'border-success/30 bg-success/5'}>
        <CardHeader className="pb-3">
        ...
        <CardContent>
          <div className="flex items-center gap-6 flex-wrap">
            <div className="flex items-center gap-2">
              <div className={`h-3 w-3 rounded-full ${downInstances.length > 0 ? 'bg-destructive animate-pulse' : 'bg-success'}`} />
              ...
              <Table>
                ...
                <TableBody>
                  {filteredInstances.map((inst) => {
                    ...
                    return (
                      <TableRow key={inst.id} className={!isConnected ? 'bg-destructive/10' : ''}>
                        <TableCell>
                          {isConnected ? (
